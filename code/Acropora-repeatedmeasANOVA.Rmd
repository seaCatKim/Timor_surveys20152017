...
ACRbracount$Site <- ordered(ACRbracount$Site, levels = c("Rural-N", "Rural-E", "Urban-E", "Urban-W"))
levels(ACRbracount$Site)[levels(ACRbracount$Site)=="Beloi"] <- "Rural-N"
levels(ACRbracount$Site)[levels(ACRbracount$Site)=="Manatuto"] <- "Rural-E"
levels(ACRbracount$Site)[levels(ACRbracount$Site)=="CristoRei"] <- "Urban-E"
levels(ACRbracount$Site)[levels(ACRbracount$Site)=="DiliRock"] <- "Urban-W"

# average branching acroporid per site, depth, year
ACRbraave_site_d_yr <- ACRbracount %>% 
   group_by( Site, Depth, Year, GEN) %>% 
