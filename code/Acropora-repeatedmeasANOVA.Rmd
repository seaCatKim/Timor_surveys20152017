...
library(readr)
comp1517 <- read_csv(here("data/CoralHealth-2015-2017edit092021-R-genmorph.csv")) 
...
comp1517_factor$long_id <- as.factor(paste(comp1517_factor$Site2,
...
leveneTest(totbra ~ Year * Sit2e * Depth, data = ACRbracount)
```
