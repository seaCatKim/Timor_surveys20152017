...
library(Rmisc)
library(tidyverse)
setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/Beloi")
bel5 <- read.csv("Bel5m-date-hourly.csv") 
bel5$Site <- "Rural-N"
bel5$Depth <- "5m"
head(bel5)
...
```{r read in Beloi 5m all data}
setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/Beloi")
bel10 <- read.csv("Bel10m-date-hourly.csv") 
bel10$Site <- "Rural-N"
bel10$Depth <- "10m"
head(bel10)
...
```{r read in DiliRock 5m all data}
 setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/DiliRock")
dil5 <- read.csv("Dil5m-date-hourly.csv")
dil5$Site <- "Urban-W"
dil5$Depth <- "5m"
...
```{r read in DiliRock 10m all data}
 setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/DiliRock")
dil10 <- read.csv("Dil10m-date-hourly.csv")
dil10$Site <- "Urban-W"
dil10$Depth <- "10m"
...
# CristoRei ----
```{r CristoRei}
 setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/CristoRei")
cr5 <- read.csv("CristoRei5m-date-hourly.csv")
head(cr5)
...
```{r CristoRei 10m}
 setwd("C:/Users/jk845/OneDrive/Documents/Timor-Leste/2017Trip/TempData/CristoRei")
cr10 <- read.csv("CristoRei10m-date-hourly.csv")
head(cr10)
...
```{r stats only ck data}

hist(ck.dmax$dmax)
ck.dmax.an <- aov(dmax~Site * Depth + as.factor(year)*as.factor(month), data = ck.dmax)
summary(ck.dmax.an)
plot(ck.dmax.an)
...
ck.dmax.glm <- glm(dmax~Site * Depth + as.factor(year)*as.factor(month), data = ck.dmax)
summary(ck.dmax.glm)

hist(ck.temp$Temp)

ck.an <- aov(Temp~Site*Depth+ month, data = ck.temp)
summary(ck.an)
plot(ck.an)
termplot(ck.an)

ck.glm <- glm(Temp~Site*Depth+ as.factor(year)*as.factor(month), data = ck.temp)
summary(ck.glm)
```


```{r read in CRW data}
coralreefwatch <- read_csv("~/OneDrive/Documents/Timor-Leste/NOAAdata/STR-tempdata/CRWdat-timor_leste_end8AUG2017_R.csv")
library(tidyverse)
...
write_csv(temp, "~/OneDrive/Documents/Timor-Leste/2017Trip/TempData/alltemp_TL.csv")
```
