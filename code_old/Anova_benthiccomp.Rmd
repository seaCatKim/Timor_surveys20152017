...
## Repeated measures ANOVA of hard coral from benthic composition LIT surveys in Timor-Leste 2017-2017

```{r }
here::here()
comp15.l <- read.csv(here::here("data/TL2015-BenthicCategories,Site,Depth-long.csv"))
comp15.l$X <- NULL
head(comp15.l)
...
comp17 <- read.csv(here::here("data/TL2017-benthiccomp-transect.csv"))
comp17$X <- NULL
head(comp17)
